...
export const TEACHER_TOOLS: TeacherTool[] = [
  ...
  },
  {
    ...
    iconName: 'ListChecks',
    status: 'active',
    tags: ['Kurikulum Merdeka & K13', 'Taksonomi Bloom', 'Rubrik 4 Skala', 'KKTP & Remedial', 'Word .docx'],
    path: '/tools/rubrik-penilaian',
    badge: 'Siap Pakai',
    features: [
      'Tabel Kisi-kisi Standar Penulisan Soal Nasional (Kaidah ABCD)',
      'Rubrik Analitik 4 Skala Capaian & Rubrik Holistik',
      'Pedoman Penskoran Uraian & Kunci Jawaban Langkah demi Langkah',
      'Interval KKTP, Rencana Remedial/Pengayaan & Lembar Nilai Siswa',
      'Ekspor Langsung ke Dokumen Microsoft Word (.docx) Siap Cetak',
    ],
    targetAudience: 'Guru Penyusun Asesmen, Penguji Ujian & Tim Kurikulum',
  },
  {
    id: 'deskripsi-rapor',
